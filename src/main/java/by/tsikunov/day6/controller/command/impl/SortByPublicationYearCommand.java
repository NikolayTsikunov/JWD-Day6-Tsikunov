...
public class SortByPublicationYearCommand implements ExecutedCommand {
    @Override
    public Map<String, String> execute(Map<String, String> parameters) {
        LibraryService service = new LibraryServiceImpl();
        Map<String, String> result = new HashMap<>();

        Response response = service.sortByPublicationYear();
        result.put("Message", "Sorted list by publication year");
